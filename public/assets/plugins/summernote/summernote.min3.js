...
!function(a) {
    ...
    if (!hasCodeMirror && isSupportAmd && "undefined" != typeof require)
        if ("undefined" != typeof require.resolve)
            ...
            "undefined" != typeof eval("require").specified && (hasCodeMirror = eval("require").specified("codemirror"));
    var agent = {
      ...
      , Context = function(a, b) {
        ...
        this.code = function(b) {
            ...
            return void 0 === b ? (this.invoke("codeview.sync"),
            c ? this.layoutInfo.codable.val() : this.layoutInfo.editable.html()) : (c ? this.layoutInfo.codable.val(b) : this.layoutInfo.editable.html(b),
            a.val(b),
        ...
        this.module = function(a, b, c) {
            return 1 === arguments.length ? this.modules[a] : (this.modules[a] = new b(this),
    ...
    var key = function() {
        ...
        this.pasteByEvent = function(b) {
            ...
            if (c && c.items && c.items.length) {
                ...
                "file" === d.kind && -1 !== d.type.indexOf("image/index.html") && a.invoke("editor.insertImagesOrCallback", [d.getAsFile()]),
      ...
      , Buttons = function(a) {
        var b = this
          ...
          , h = this.representShortcut = function(a) {
            ...
            b = b.replace("BACKSLASH", "\\").replace("SLASH", "http://coderthemes.com/").replace("LEFTBRACKET", "[").replace("RIGHTBRACKET", "]"),
            " (" + b + ")") : ""
        }
        ;
        this.initialize = function() {
      ...
      , HintPopover = function(a) {
        ...
        this.replace = function() {
            ...
            if (b.length) {
                ...
                this.hide(),
                a.invoke("editor.focus"),
                a.invoke('editor.pasteHTML', '&zwnj;')
            }
        }
        ,
