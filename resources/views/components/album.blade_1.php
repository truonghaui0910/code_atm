...
//        e.preventDefault();
//        
//        const album = window.currentAlbumData;
//        
...
//        }
//
//        // Set album cover preview (existing image)
//        if (album.coverImg) {
//            $('#imagePreview').html(`<img src="${album.coverImg}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 5px;">`);
//            // Store existing image URL for edit mode
//            currentUploadedImageUrl = album.coverImg;
//        } else {
//            $('#imagePreview').html(`<i class="fas fa-image fa-3x music-icon"></i>`);
//        }
//
...
/**
 * Show error state in image preview
 */
...
async function uploadImageToCDN(file) {
    try {
        ...
        // Upload file to CDN using presigned URL
        ...
        // Success - show preview and store URL
...
//    });
 $('#albumCover').off('change').on('change', handleImageInputChange);
    ...
    // Update the existing form submission to use uploaded URL
    ...
    // Update create album button click to reset image state
