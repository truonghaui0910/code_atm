...
@section('content')
    <style>
        ...
        .filter-btn-pending.active {
            ...
            /* warning - vàng */
            color: #212529;
            /* chữ màu đen để dễ đọc trên nền vàng */
        }
        ...
        .albums-table tbody tr:nth-child(1) {
            animation-delay: 0.1s;
        }

        .albums-table tbody tr:nth-child(2) {
            animation-delay: 0.15s;
        }

        .albums-table tbody tr:nth-child(3) {
            animation-delay: 0.2s;
        }

        .albums-table tbody tr:nth-child(4) {
            animation-delay: 0.25s;
        }

        .albums-table tbody tr:nth-child(5) {
        ...
        .album-cover.loaded+.album-cover-placeholder {
            opacity: 0;
            pointer-events: none;
        }
        ...
        .table-album-cover-wrapper .album-cover.lazy-loading {
            opacity: 0;
        }

        .table-album-cover-wrapper .album-cover.loaded {
            opacity: 1 !important;
        }

        .table-album-cover-wrapper .album-cover.loaded+.table-cover-placeholder {
            opacity: 0;
            pointer-events: none;
        }
        ...
        .table-image-loading-spinner {
            pointer-events: none;
        }

        .table-album-cover-wrapper .album-cover.error+.table-cover-placeholder {
            background-color: #f8d7da !important;
            color: #721c24 !important;
        }

        .table-album-cover-wrapper .album-cover.error+.table-cover-placeholder i::before {
            content: "\f071";
        }
        ...
        input:checked+.cherry-slider {
            background-color: #28a745;
        }

        input:focus+.cherry-slider {
            box-shadow: 0 0 1px #28a745;
        }

        input:checked+.cherry-slider:before {
