...
//        $loginpassw = "jcqpvqtez-rotate:tedzuonzv900";
//        $proxy_port = 33335;
//        $proxy_ip = "brd.superproxy.io";
//        $loginpassw = "brd-customer-hl_308cb727-zone-zone2:lrd0scc2gwto";
...
//        error_log($response);
        ...
        //lưu thông tin sử dụng proxy
        $rqLog = new \App\Http\Models\RequestLog();
        $rqLog->url = $url;
        $rqLog->created = \App\Common\Utils::timeToStringGmT7(time());
        $rqLog->proxy = "$loginpassw@$proxy_ip:$proxy_port";
        $rqLog->size = $info['size_download'];
        $rqLog->save();
        curl_close($curl);
//        unlink($cookie_file);
