...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Channel Management 30 ({{ $datas->total()}})</h4>
...
<!--            <a id="btn-upload" href="#dialog-import" data-animation="flash" data-plugin="custommodal" title="Import channel"
            ...
            <a id="btn-dowload" title="Export to cvs" href="/channel/download30" ><i class="mdi mdi-cloud-download"></i></a>
        </div> 
    </div>
</div>


<form id="formSearchChannel" action="/channel30" method="GET">
    {{ csrf_field() }}
...
<!--                <th style="width: 10%" class="footable-visible footable-sortable text-center">@sortablelink('subscribes','Subs')</th>
                <th style="width: 10%" class="footable-visible footable-sortable text-center">@sortablelink('views','Views')</th>
                <th style="width: 10%" class="footable-visible footable-sortable text-center">@sortablelink('increasing','Increase')</th>
                <th style="width: 10%" class="footable-visible footable-sortable text-center">@sortablelink('status','Status')<span class="footable-sort-indicator"></span></th>-->
