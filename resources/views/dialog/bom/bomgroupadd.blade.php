<div class="modal fade" id="dialog_bom_group_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        ...
        <div class="modal-content">
                ...
                <div class="d-flex justify-content-sm-between align-items-center w-100">
                    <div>
                        <h5 class="modal-title mt-0 d-flex align-items-center">
                            ...
                            <strong id="dialog-task-title">Add Group</strong>
                        </h5>
                    </div>
                    <div class="">
            ...
            <div id="content-dialog" class="modal-body">
                <form id="formaddgroup" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" id="bom_gr_id" name="bom_gr_id"/>
                    <div class="add_new_group_list  fadeInDown">
                        <div class="col-md-12">
                            <div class="form-group row">
                                <label class="col-8 col-form-label">Group Name</label>
                                <div class="col-12">
                                    <input id="group_name" class="form-control" type="text" name="group_name" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <button data-toggle="tooltip" data-placement="top" data-original-title="" type="button"
                                class="btn float-right" onclick="addGroup()"><i class="fa fa-save"></i> Save</button>
                        </div>
                    </div>
