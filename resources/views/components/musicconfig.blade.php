...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <h4 class="page-title">Music config</h4>
            <ol class="breadcrumb float-right">
                <li class="breadcrumb-item"><a href="#">Automusic</a></li>
                <li class="breadcrumb-item active">Music config</li>
            </ol>
...
<form id="formMusic" class="form-horizontal form-label-left"  method="GET">
    ...
    @include('pannel.source')
    @include('pannel.sort_filter')
    @include('pannel.background')
    @include('pannel.style_text')


    <div class="row">    
        @include('pannel.title')
    </div>
    <div class="row">    
        @include('pannel.outtro')
    </div>
    <div class="div_type_reup_2 disp-none">
        @include('pannel.advanced')
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
...
//                but.button('reset');
    ...
    function previewFunction() {
        ...
        if ($(".ck_style_title_song").prop("checked") == true) {
            ck_style_title_song = 1;
        }
        ...
        var font_name_title = $("#font_name_title").val();
        var font_size_title = $("#font_size_title").val();
        var pos_title = $("#pos_title").val();
        var pos_x_title = $("#pos_x_title").val();
        var pos_y_title = $("#pos_y_title").val();
        var font_color_title = $("#font_color_title").val().replace("#", "");
        var text_stroke_size_title = $("#text_stroke_size_title").val();
        var text_stroke_color_title = $("#text_stroke_color_title").val().replace("#", "");
        var rotation_title = $("#rotation_title").val();

        $("#img-preview").attr("src", "/ajaxPreviewImage?text_data=" + text_data + "&font_size=" + font_size +
                "&ck_style_title_song=" + ck_style_title_song +
                ...
                "&rotation=" + rotation +
                "&font_name_title=" + font_name_title +
                "&font_size_title=" + font_size_title +
                "&pos_title=" + pos_title +
                "&pos_x_title=" + pos_x_title +
                "&pos_y_title=" + pos_y_title +
                "&font_color_title=" + font_color_title +
                "&text_stroke_size_title=" + text_stroke_size_title +
                "&text_stroke_color_title=" + text_stroke_color_title +
